...
static pid_controller_t pids[3] = {
    {.kp = 150.0f, .ki = 70.0f, .kd = 0.0f, .integral = 0, .prev_measured = 0, .prev_error = 0, .out_max = 100.0f, .out_min = -100.0f},
    {.kp = 150.0f, .ki = 70.0f, .kd = 0.0f, .integral = 0, .prev_measured = 0, .prev_error = 0, .out_max = 100.0f, .out_min = -100.0f},
    {.kp = 150.0f, .ki = 70.0f, .kd = 0.0f, .integral = 0, .prev_measured = 0, .prev_error = 0, .out_max = 100.0f, .out_min = -100.0f}
};
...
static const float lut_pulses[3][43] = {
    {0.0f, 82.0f, 134.0f, 188.0f, 222.0f, 256.0f, 294.0f, 325.0f, 351.0f, 370.0f, 394.0f, 422.0f, 442.0f, 451.0f, 493.0f, 522.0f, 541.0f, 570.0f, 602.0f, 603.0f, 645.0f, 664.0f, 693.0f, 722.0f, 723.0f, 764.0f, 789.0f, 809.0f, 841.0f, 842.0f, 888.0f, 889.0f, 931.0f, 968.0f, 969.0f, 1011.0f, 1030.0f, 1059.0f, 1094.0f, 1095.0f, 1135.0f, 1136.0f, 1137.0f},
    {0.0f, 93.0f, 160.0f, 207.0f, 231.0f, 274.0f, 302.0f, 332.0f, 359.0f, 368.0f, 382.0f, 401.0f, 430.0f, 463.0f, 464.0f, 510.0f, 529.0f, 558.0f, 562.0f, 609.0f, 628.0f, 652.0f, 670.0f, 707.0f, 708.0f, 749.0f, 777.0f, 796.0f, 829.0f, 830.0f, 876.0f, 895.0f, 924.0f, 956.0f, 957.0f, 998.0f, 1017.0f, 1053.0f, 1056.0f, 1101.0f, 1126.0f, 1132.0f, 1133.0f},
    {0.0f, 82.0f, 135.0f, 179.0f, 218.0f, 256.0f, 284.0f, 327.0f, 331.0f, 370.0f, 361.0f, 404.0f, 423.0f, 466.0f, 467.0f, 521.0f, 542.0f, 543.0f, 585.0f, 613.0f, 631.0f, 660.0f, 693.0f, 694.0f, 736.0f, 754.0f, 784.0f, 808.0f, 809.0f, 850.0f, 877.0f, 896.0f, 928.0f, 929.0f, 976.0f, 999.0f, 1023.0f, 1027.0f, 1075.0f, 1102.0f, 1127.0f, 1131.0f, 1132.0f}
};
